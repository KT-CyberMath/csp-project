README
# Computer Systems and Programming — Client Server System
A.Y. 2025–2026
Name: Konstantinos Tziakouris


# CSP Client–Server System (C)


A Linux-based client–server system implemented in C for the **Computer Systems and Programming** course (Sapienza University of Rome).

The project implements a TCP server that manages multiple clients, user home directories, file operations, and concurrent access control.
...
- Privilege dropping for safe file operations
- Background file transfers
- Inter-user file transfer requests
